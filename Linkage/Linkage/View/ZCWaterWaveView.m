...
@implementation ZCWaterWaveView
{
...
- (void)drawRect:(CGRect)rect
{
    ...
    self.imgV.frame = CGRectMake(rect.size.width / 2 - imgVH / 2, 80, imgVH, imgVH);
    self.imgV.image = [UIImage imageNamed:@"YangC"];
    self.imgV.layer.cornerRadius = imgVH * 0.5;
